use std::{collections::{HashMap, HashSet}, fmt::Display, thread::sleep, time::Duration};
...
pub fn make_paginated_github_request<T>(
    gh_token: &str,
    page_size: u8,
    url: &str,
    retries: u8,
...
pub fn make_paginated_github_request_with_index<T>(
    gh_token: &str,
    page_size: u8,
    url: &str,
    retries: u8,
